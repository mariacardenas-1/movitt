...
export default function BarraContacto () {
    return (
        <div className=" justify-center md:mt-48 desk:mt-40 2xl:mt-24 px-5 gap-2.5 desk:px-80 lg:px-20 flex flex-col lg:flex-row items-center lg:justify-between bg-movittBlue text-white max-w-full h-40 md:h-36 font-semibold text-base lg:text-xl">
