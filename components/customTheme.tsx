export const theme = {
    ...
    button: {
        base: 'group flex h-min items-center justify-center p-0.5 text-left font-medium focus:z-10',
        fullSized: 'w-full',
        color: {
    ...
    tab: {
        ...
        tablist: {
            ...
            styles: {
                ...
                pills: 'flex-wrap font-medium text-lg text-gray-500 dark:text-gray-400',
                fullWidth: 'hidden text-lg font-medium rounded-lg divide-x divide-gray-200 shadow sm:flex dark:divide-gray-700 dark:text-gray-400',
            },
            tabitem: {
                base: 'flex items-center justify-start p-4 text-lg font-medium first:ml-0 disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500',
                styles: {
                    default: {
                        base: 'rounded-t-lg',
                        active: {
                            on: 'bg-gray-100 text-green-600 dark:bg-gray-800 dark:text-blue-500',
                    ...
                    underline: {
                        base: 'rounded-t-lg',
                        active: {
                            on: 'text-movittBlue text-left w-72 md:w-48 text-lg rounded-t-lg border-b-2 border-yellow-400  bg-movittgray active dark:text-blue-500 dark:border-blue-500',
                            off: 'border-b-2 w-72 text-left md:w-48 text-lgborder-transparent text-movittBlue hover:border-gray-300 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300',
                        },
                    },
                    pills: {
                        base: '',
            ...
            point: {
                ...
                marker: {
                    ...
                    icon: {
                        ...
                        wrapper: 'absolute -left-3 flex h-6 w-6 items-center justify-start rounded-full bg-blue-200 ring-8 ring-white dark:bg-blue-900 dark:ring-gray-900',
                    },
                },
                vertical: '',
            },
